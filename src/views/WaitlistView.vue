<template>
  <div>
    <HeroSection class="mx-auto max-w-4xl text-center px-10 py-15 mt-15 md:py-20 md:mt-30" />
    ...
    <WaitlistForm class="mx-auto max-w-6xl text-center px-10 py-15 md:py-20" />
  </div>
</template>
