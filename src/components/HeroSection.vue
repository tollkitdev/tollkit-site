<template>
  <section class="text-center">
    <!-- <h1 class="text-4xl leading-15 font-bold text-primary">
      If Stripe had <code class="bg-neutral text-white px-2 py-1 rounded">canAccess()</code>, this
      would be it.
    </h1>

    <p class="text-lg text-neutral my-6">
    ...
    <p class="text-lg">
      Stop duplicating access checks across your stack. Tollkit gives you simple APIs to gate
      features, routes, and backend logic by plan, role, and payment status.
    </p>
  </section>
</template>
